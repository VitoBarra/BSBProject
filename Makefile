...
.PHONY: help docker-build shell run prepare-dea dea dea-plots enrichment enrichment-plots analysis multiqc-raw multiqc-clean network-bc-download network-bc-analyze network-bc network-disgenet-download
